...
5. **Reviewers converge over time.** Start with a reviewer that's good enough, then sharpen it from the escapes you hit in production. This is the escape-to-improvement loop, and it is a governance story: the human team owns the reviewers and adjusts them as escapes come in. No reviewer ever gets everything right, but with feedback from the codebase and from agent-authored PRs the team keeps steering them in the right direction.
